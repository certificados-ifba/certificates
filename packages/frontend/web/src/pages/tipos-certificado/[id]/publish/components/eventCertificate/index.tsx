...
import { Certificate } from '@pages/tipos-certificado/[id]/[tab]/components'
import { initialTextConfig } from '@pages/tipos-certificado/[id]/[tab]/components/certificateLayout'
  ...
  useEffect(() => {
    const loadModels = async () => {
      ...
      try {
        ...
        const modelsRes = await api.get(`tipos-certificado/${event.id}/models`)
